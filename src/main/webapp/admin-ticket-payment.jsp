	                                ...
	                                <div class="row justify-content-center">
	                                    <div class="col-11">
	                                        <div class="form-card">
	                                            ...
	                                            <form action="AdminPaymentProcess?booking-type=ticket" method="post" id="form" class="form" name="form">
	                                ...
	                                <div class="row justify-content-center">
	                                    <div class="col-11">
	                                        <div class="form-card">
	                                            ...
	                                            <form action="AdminPaymentProcess?booking-type=ticket" method="post" id="form1" class="form1" name="form1">
	                                                <div class="row">
	                                                    <div class="col-12 form-group has-feedback">
