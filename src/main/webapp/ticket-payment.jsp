...
<script type='text/javascript' src='<%=request.getContextPath()%>/resources/js/gatewayVal1.js'></script>
	                    ...
	                    <div class="bg-light border-right" id="sidebar-wrapper">
	                        ...
	                        <div class="list-group list-group-flush">
	                            ...
	                            <a data-toggle="tab" href="#menu3" id="tab3" class="tabs list-group-item bg-light">
		                            <div class="list-div my-2">
		                            	<div class="fa fa-wallet"></div> &nbsp;&nbsp;&nbsp; Wallet Pay
		                            </div>
	                            </a>
		   					</div>
	                    </div> <!-- Page Content -->
	                    <div id="page-content-wrapper">
	                        <div class="row pt-3" id="border-btm">
	                            ...
	                            <div class="col-8">
	                                ...
	                                <div class="row justify-content-right">
	                                    <div class="col-12">
	                                        <p class="mb-0 mr-4 text-right">Pay: <span class="top-highlight"><i class="fas fa-rupee-sign"></i> <span id = "fareAmount">${Fare}</span></span> </p>
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
	                        ...
	                        <div class="tab-content">.
	                                ...
	                                <div class="row justify-content-center">
	                                    <div class="col-11">
	                                        <div class="form-card">
	                                            ...
	                                            <form action="PaymentProcess?booking-type=ticket" method="post" id="form" class="form" name="form">
	                                ...
	                                <div class="row justify-content-center">
	                                    <div class="col-11">
	                                        <div class="form-card">
	                                            ...
	                                            <form action="PaymentProcess?booking-type=ticket" method="post" id="form1" name="form1" class="form1">
	                                                <div class="row">
	                                                    <div class="col-12 form-group has-feedback">
	                            ...
	                            <div id="menu3" class="tab-pane">
	                                <div class="row justify-content-center">
	                                    <div class="col-11">
		                   					<div class="form-card">
	                                        	<h3 class="mt-0 mb-4 text-center">Pay by using your Wallet Amount</h3>
	                                            <form action="PaymentProcess?booking-type=ticket" method="post" id="form2" name="form2" class="form2">
			            							<div class="row">
	                                                	<div class="col-12 form-group has-feedback">
	                                                    	<br/><br/><br/><h5>Wallet Amount: <span id = "walletAmount">${Wallet}</span></h5>
	                                                    </div>
	                                                </div> 
			            							<div class="row">
			            								<input type="hidden" name = "payment-type" value = "wallet" id = "walletPaymentButton">
	                                                	<div class="col-md-12"><br/><br/><br/><br/><br/><br/><br/><br/><br/> <input type="submit" value="PAY" class="btn btn-success placeicon" name="btn"> </div>
	                                                </div>
		                             			</form> 
