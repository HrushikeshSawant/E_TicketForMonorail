	                    ...
	                    <div id="page-content-wrapper">
	                    	<div class="row pt-3" id="border-btm">
	                            ...
	                            <div class="col-8">
	                                ...
	                                <div class="row justify-content-right">
	                                    <div class="col-12">
	                                        <p class="mb-0 mr-4 text-right" float:"right">Pay: <span class="top-highlight"><i class="fas fa-rupee-sign"></i> ${Amount}</span> </p>
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
	                                ...
	                                <div class="row justify-content-center">
	                                    <div class="col-11">
	                                        <div class="form-card">
	                                            ...
	                                            <form action="Wallet" method="post" id="form" class="form" name="form">
	                                                ...
	                                                <div class="row">
	                                                    ...
	                                                    <div class="col-12 form-group has-feedback">
	                                                        ...
	                                                        <div class="input-group form-group has-feedback"> <input type="text" id="scode" name="scode" value="" class="placeicon" minlength="8" maxlength="11" autocomplete="off"> <label>ACCOUNT NUMBER</label> </div>
	                                                    </div>
	                                                    <div class="col-12 form-group has-feedback">
	                                                      <span id = "icodeStatus" class = "errorHeader"><b>*</b></span>
	                                                      <div class="input-group form-group has-feedback"> <input type="text" id="icode" name="icode" value="" class="placeicon" minlength="8" maxlength="11" autocomplete="off"> <label>IFSC CODE</label> </div>
	                                                    </div>
	                                                </div>
	                                                <div class="row">
	                                ...
	                                <div class="row justify-content-center">
	                                    <div class="col-11">
	                                        <div class="form-card">
	                                            ...
	                                            <form action="Wallet" method="post" id="form1" class="form1" name="form1">
	                                                <div class="row">
	                                                    <div class="col-12 form-group has-feedback">
	                                                        <span id = "co_nameStatus" class = "errorHeader"><b>*</b></span>
	                                                        <div class="input-group form-group has-feedback"> <input type="text" id="co_name" name="co_name" value="" minlength="10" maxlength="30" autocomplete="off"> <label>NAME ON CARD</label> </div>
	                                                    </div>
	                                                </div>
	                                                <div class="row">
	                                                  <div class="col-12 form-group has-feedback">
	                                                      <span id = "cr_noStatus" class = "errorHeader"><b>*</b></span>
	                                                      <div class="input-group form-group has-feedback"> <input type="text" id="cr_no" name="cr_no" value="" minlength="19" maxlength="19" autocomplete="off"> <label>CARD NUMBER</label> </div>
	                                                  </div>
