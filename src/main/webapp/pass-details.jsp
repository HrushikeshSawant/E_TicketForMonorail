...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/style15.css" type="text/css">
<title>Details</title>
...
<body>
	...
	<div class="box">
		...
		<a href="SendDetailsMail?type=pass&user-type=user">Click Here to Redirect>></a>
		</div>
	</div>
	</div>
